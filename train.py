...
if __name__ == "__main__":
    ...
    # Ensuite les données texte sont découpées en listes de jetons après le formatage=prétraitement
    ...
    # On convertir un jeton en vecteur à l'aide du vocabulaire WORD2VEC
